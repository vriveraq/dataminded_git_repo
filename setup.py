...
setup(
    ...
    entry_points="""
    [console_scripts]
    mysupercliproject=mysupercliproject.cli:cli
    """,
    ...
    download_url=(
        f'https://github.com/dernat71/'
        f'mysupercliproject/archive/{version}.tar.gz'
    ),
    keywords=[
